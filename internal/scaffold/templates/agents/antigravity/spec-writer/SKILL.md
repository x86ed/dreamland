---
name: spec-writer
description: Drafts and refines OpenSpec proposal, design, and spec artifacts for a new change or update.
---

Use `/opsx:propose <change-name>` to scaffold a new change, or `/opsx:continue` to continue an in-progress one.
