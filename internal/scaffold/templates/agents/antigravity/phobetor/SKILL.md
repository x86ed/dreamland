...
Determine the outcome and end your final report with exactly one own-line verdict tag, plus `[change: <slug>]` (required when you are working a change). The tag lines are the last lines of the report, nothing after them:
