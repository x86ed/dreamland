...
- [ ] 2.2 Add `zhougong_snapshot` to `cmd/mcp_zhougong.go` returning per-branch `headSha`, `collectedAt`, `stale`, `missing`, summary and runs; add it to zhougong's `tools` list.
