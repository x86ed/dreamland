...
- **Compare view**: pick two branches/features (feature = OpenSpec change slug resolved to its branch), side-by-side metric table with absolute delta and percent delta, plus flow-path diff.
